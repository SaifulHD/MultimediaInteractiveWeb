...
<body>
    ...
    <section class="hero ">
        <div class="cardvideo">
            ...
            <div class="rightcard">
                <h1 class="h1card">Sinkronous & <br> Asinkronous</h1>
            ...
            <div class="text-center">
                ...
                <iframe class="embeddedObject shadow resizable" name="embedded_content" scrolling="no" frameborder="0" type="text/html" style="overflow:hidden;height: 428px;width: 80%;" src="https://www.screencast.com/users/hayuslurd/folders/Camtasia%20Studio/media/8a7351f2-529e-4148-83ea-97f2aa57df1a/embed" height="1080" width="1920" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
