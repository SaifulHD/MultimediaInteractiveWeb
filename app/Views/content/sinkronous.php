    ...
    <section class="hero">
        <div class="cardvideo" data-aos="fade-up">
            <div class="thumbnailvideo">
                <img class="leftphoto" src="<?= base_url('assets/img/sinkronous.gif'); ?> " alt="" />
            </div>
            <div class="rightcard">
                <h1 class="h1card"><strong>Pertemuan 1</strong> Sinkronous</h1>
            ...
            <div class="text-center">
                ...
                <iframe class="embeddedObject shadow resizable" name="embedded_content" scrolling="no" frameborder="0" type="text/html" style="overflow:hidden;height: 428px;width: 80%;margin-top: 20px; " src="https://www.screencast.com/users/hayuslurd/folders/Camtasia%20Studio/media/f3a88f87-d02a-4263-844f-36d073925478/embed" height="1080" width="1920" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
            <div class="fab"><a href="/Home/asinkronous"><i class="fa fa-arrow-right fa-3x"> </i></a></div>
        </div>
    </section><!-- End Hero -->
