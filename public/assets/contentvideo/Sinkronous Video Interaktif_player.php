...
<body>
  ...
  <script type="text/javascript">
    (function(window) {
      function setup(TSC) {
        TSC.playerConfiguration.addMediaSrc("Sinkronous Video Interaktif.mp4");
        TSC.playerConfiguration.setXMPSrc("Sinkronous Video Interaktif_config.xml");
        ...
        TSC.playerConfiguration.setPosterImageSrc("Sinkronous_Video_Interaktif_First_Frame.png");
